...
You may notice flickering if you use a camera to look at the clock. If this is a concern, you may change the capacitor value to increase the frequency to the desired level. Full details in the schematics.
...
## 3D models
The clock may be completed by printing the case. See [3D printed parts](3D printed parts) folder. 
